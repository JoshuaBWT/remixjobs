...
exports.findAll = function(req, res, latest) {
    ...
    query.exec(function(err, jobs) {
        ...
        if(jobs.length == 0 && req.query.contract == null && req.query.category == null && req.query.where == null)
          scraper.fetchAllJobs(req, res, function(allJobs) {
              res.json({message : "empty request : we updated the database. Now please try again"});
          });
        else
          res.json(jobs);
    });
